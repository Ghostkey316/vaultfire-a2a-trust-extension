...
|----------------------------|--------------------------------------------------|-----------|
| `@vaultfire/agent-sdk`     | Core SDK for building Vaultfire-registered agents| Published |
| `@vaultfire/a2a`           | A2A Agent Card enrichment and verification       | Published |
| `@vaultfire/langchain`     | LangChain/LangGraph integration                  | Published |
